...
function JourneyPassion() {
  return (
    ...
    >
      ...
      <div className=" overflow-hidden inset-0 bg-[url('/dot-grid-spacing.svg')] bg-contain bg-repeat  bg-secondary-cream flex items-center justify-center lg:justify-center  
      ...
      <div className="flex flex-col gap-5 font-poppins text-xs lg:text-lg order-3">
        ...
        A journey that began in the discipline of qualitative research,
         Ameya’s career has spanned leadership roles across research,
          advertising, and marketing, earning accolades from both clients and
        ...
        Throughout this journey of collaborating with clients across sectors
         such as BFSI, CPG, real estate, consumer electronics, telecom,
          automotive, media, and fashion & apparel, among others, one
           constant has been a deep passion for a ground-up approach to
            understanding consumer preferences and human psychology

        </p>
        <p className="">
        Backed by a trifecta of consumer insights, brand strategy, and
         marketing—enriched by life experiences gained through immersion
          in diverse cultures across five continents—Ameya’s next chapter took
           shape with the founding of Equilibrium, a company created with the
            vision to democratize not just research but the entire marketing funnel
